...
function(t, e) {
    ...
    if (function(t, e) {
        ...
        function i(e) {
        	console.log("i:"+t.devicePixelRatio);
        ...
        console.log("n.entry:"+n.entry);
        console.log("n.runOnce:"+n.runOnce);
        console.log("n.getAttribute:"+u.getAttribute(n.attr));
        console.log("n.config:"+n.config);
        console.log("n.keepz:"+l.keepz);
        console.log("n.attr:"+n.attr);
        if (n.runOnce = ++n.entry > 1 || u.getAttribute(n.attr), !(n.runOnce && (n.config && (l.keepz && n.$ && (t.Zepto = t.$ = n.$, delete n.$), o(function() {
        	console.log("-------------------------run-------------Once::::"+1e3+"----------------------------------------");
            n.state = 1e3,
    ...
    function(t, e) {
    	console.log("allmobilize_loader页面加载中");
    ...
    function(t, e, n, r, i) {
        ...
        if (!n.runOnce && !r.isOldBrowsers) {
            ...
            var b = function(t) {
                return /(yunshipei|allmobilize)\.(com|net)/.test(t) || /192\.168/.test(t)|| /127\.0/.test(t) || /localhost/.test(t) || /ysp\.www\.gov\.cn/.test(t)
            },
            w = function(e) {
                if (e) {
            ...
            k = S(p) ? p: k,
            r.device = k;
            console.log("r.device:"+r.device);
            console.log("r.device:"+r.options.devices[k]);
            console.log("r.render:"+r.render);
        ...
        function(e) {
            function n(t, n, r) {
                var i = e.Event(n);
                console.log("isDefaultPrevented:------"+i);
    ...
    function(t, e, n) {
        ...
        r.registerModule = function(r) {
            ...
            console.log("registerModule:::"+r.name);
        }
    } (n, n.config, n.logger),
    function(t, e, n, r, i, o) {
        if (!n.runOnce && !r.isOldBrowsers) {
            ...
            a.onPlatformReady = function(t) {
            	console.log("onPlatformReady:"+r.render);
                if (r.render) {
                	console.log("r.options.splitmode:"+r.options.splitmode);
                    if (r.options.splitmode) {
                        n.p.loading = !0;
                        console.log("loading:"+n.p.loading);
                        var e = u();
                        p(e,
                        function() {
                            n.p.loading = !1,
    ...
    function(t, e, n, r, i, o, a) {
        ...
        if (!n.runOnce && !r.isOldBrowsers) {
            ...
            w.prototype.insertPlatformScripts = function(t) {
            	console.log("-------------insertPlatformScripts-----------------");
                var e = {
                    charset: "utf-8",
                    id: n.id,
                    src: r.srcUrl
    ...
    function(t, e, n, r, i, o, a, s, c) {
        ...
        if (!n.runOnce && !i.isOldBrowsers) {
            ...
            C = function(t, e, s, c) {
            	console.log(" C = function(t, e, s, c):");
            	console.log("TTT:::"+t);
            	console.log("EEE:::"+e);
            	console.log("SSS:::"+s);
            	console.log("CCC:::"+c);
    ...
    function(t, e, n, r, i, o) {
        ...
        a.onMobilizedDocReady = function(t, e) {
        	console.log("a.onMobilizedDocReady");
            this.entry || (this.entry = h(e.doc))
        }
    ...
    !function(t, e, n) {
    	console.log("e.runOnce:------"+e.runOnce);
